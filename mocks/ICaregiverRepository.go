...
func (_m *ICaregiverRepository) GetByEmail(email string) (*models.Caregiver, error) {
	ret := _m.Called(email)
...
func (_m *ICaregiverRepository) GetByID(id uuid.UUID) (*models.Caregiver, error) {
	ret := _m.Called(id)
...
func (_m *ICaregiverRepository) GetByUserID(uid uuid.UUID) (*models.Caregiver, error) {
	ret := _m.Called(uid)
