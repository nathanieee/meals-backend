...
func (_m *ICaregiverRepository) FindByID(id uuid.UUID) (*models.Caregiver, error) {
	ret := _m.Called(id)
...
func (_m *ICaregiverRepository) FindByUserID(uid uuid.UUID) (*models.Caregiver, error) {
	ret := _m.Called(uid)
