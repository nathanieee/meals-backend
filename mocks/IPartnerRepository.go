...
func (_m *IPartnerRepository) FindByEmail(email string) (*models.Partner, error) {
	ret := _m.Called(email)
	...
	var r0 *models.Partner
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*models.Partner, error)); ok {
		return rf(email)
	}
	if rf, ok := ret.Get(0).(func(string) *models.Partner); ok {
		r0 = rf(email)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Partner)
...
func (_m *IPartnerRepository) FindByUserID(uid uuid.UUID) (*models.Partner, error) {
	ret := _m.Called(uid)
