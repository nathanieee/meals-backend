...
func (_m *IPartnerRepository) GetByEmail(email string) (*models.Partner, error) {
	ret := _m.Called(email)
...
func (_m *IPartnerRepository) GetByID(pid uuid.UUID) (*models.Partner, error) {
	ret := _m.Called(pid)
...
func (_m *IPartnerRepository) GetByUserID(uid uuid.UUID) (*models.Partner, error) {
	ret := _m.Called(uid)
