...
func (_m *IOrganizationRepository) GetByEmail(email string) (*models.Organization, error) {
	ret := _m.Called(email)
...
func (_m *IOrganizationRepository) GetByID(id uuid.UUID) (*models.Organization, error) {
	ret := _m.Called(id)
...
func (_m *IOrganizationRepository) GetByUserID(uid uuid.UUID) (*models.Organization, error) {
	ret := _m.Called(uid)
